...
var n = 1521738; //number of itens 575 - 1521738
...
var fs4 = require('fs');
var text22 = fs4.readFileSync(file2, "utf8"); //subjects.dbpedia
...
/*
var fs2 = require('fs');
var text2 = fs2.readFileSync("file2", "utf8"); //subjects.dbpedia

text2.split(/\r?\n/).forEach(function (line2) {
   totfile2+=1;
   if ((bloom.test(line2) == true) && (line2!="")) {
	totbloompos+=1; line2aux += line2 + '\r'
   }
});
*/
